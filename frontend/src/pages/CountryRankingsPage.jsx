    ...
    >
      ...
      {!weightsAdjusted ? (
        <>
          ...
          <section className="h-screen flex flex-col justify-center items-center snap-start px-4 sm:px-8 py-12">
            ...
            <h2 className="text-black/50 max-w-[90%] sm:max-w-[60%] font-light text-xs sm:text-sm lg:text-md italic mb-6 text-center">
              <span className="hidden md:block">Drag the orange sliders to tell us what matters most to you.</span>
              <span>Press the orange buttons to tell us what matters to you.</span>
            </h2>
            <div className="w-full px-2 sm:px-8 flex flex-col items-center gap-6">
              ...
              <button
                className={`bg-[#ec5b22] hover:bg-[#df4c12] text-white font-semibold w-full sm:w-40 py-2 sm:py-3 rounded-full text-base sm:text-lg transition flex items-center justify-center ${
                  !areWeightsAdjusted(pendingWeights, metricGroups)
        ...
        <>
          ...
          <section
            ref={tableRef}
            className="flex flex-col items-center h-screen snap-start overflow-auto bg-gradient-to-t from-white to-[#fff5f0] px-2 sm:px-6 lg:px-12 py-28"
          >
            {rankings.length > 0 && (
